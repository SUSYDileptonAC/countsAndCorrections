...
def getFilePathsAndSampleNames(path):
	...
	for filePath in glob("%s/sw538*.root"%path):
		sampleName = match(".*sw538v.*\.cutsV23Dilepton.*\.(.*).root", filePath).groups()[0]
...
if (__name__ == "__main__"):
	setTDRStyle()
	path = "/home/jan/Doktorarbeit/Dilepton/projects/Crosschecks/nonPrompt"
	...
	for ev in eeTrees["TTJets_MGDecays_madgraph_Summer12_New"]:
		print ev.motherPdgIdETH1, ev.motherPdgIdETH2
