...
def getErrHist(plot,combination,region,ofHist,dyHist,rSFOFErr):
	...
	for i in range(0,hist.GetNbinsX()+1):
		graph.SetPoint(i,17.5+(i)*5,dyHist.GetBinContent(i) + ofHist.GetBinContent(i))
		graph.SetPointError(i,2.5,2.5,(hist.GetBinError(i)**2 + dyHist.GetBinContent(i) + ofHist.GetBinContent(i))**0.5,(hist.GetBinError(i)**2 + dyHist.GetBinContent(i) + ofHist.GetBinContent(i))**0.5)			
	for i in range(1,hist.GetNbinsX()+1):
