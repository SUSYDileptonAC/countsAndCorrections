...
def plotDistribution(histEE, histMM, plot):
        ...
        template.setFolderName("etaPlots")
        template.saveAs("eta_%s"%plot.variablePlotName)
...
def main():
        ...
        for selectionName in args.selection:
                ...
                createEtaDistributions(selection, "leadingAbsEtaPlot") 
                createEtaDistributions(selection, "trailingAbsEtaPlot") 
