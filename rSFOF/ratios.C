...
int ratios(void) {
  ...
  getRmueAndError(45745*lumifactor,38585*lumifactor,rmue_c.v,rmue_c.e);
  getRmueAndError(28964*lumifactor,20530*lumifactor,rmue_f.v,rmue_f.e);
...
//  getRmueAndError(28765,20429,rmue_f.v,rmue_f.e);
  ...
  int kEE_c = 1238*lumifactor, nEE_c = 1278*lumifactor, kMM_c = 237*lumifactor, nMM_c = 243*lumifactor, kEM_c = 86*lumifactor, nEM_c = 89*lumifactor;
  int kEE_f =  337*lumifactor, nEE_f =  346*lumifactor, kMM_f =  85*lumifactor, nMM_f =  89*lumifactor, kEM_f = 22*lumifactor, nEM_f = 25*lumifactor;
