...
def saveTable(table, name):
	#~ tabFile = open("tab/table_%s_Run2016B_2fb.tex"%name, "w")
	tabFile = open("tab/table_%s_Run2016B_2fb_old.tex"%name, "w")
	tabFile.write(table)
	tabFile.close()
...
def main():
	...
	#~ dataPkls = loadPickles("shelves/rSFOF_Control_Run2016B_2fb.pkl")
	#~ dataBarrelPkls = loadPickles("shelves/rSFOF_ControlCentral_Run2016B_2fb.pkl")
	#~ dataEndcapPkls = loadPickles("shelves/rSFOF_ControlForward_Run2016B_2fb.pkl")
	#~ mcPkls = loadPickles("shelves/rSFOF_Control_Run2016B_2fb_MC.pkl")
	#~ mcBarrelPkls = loadPickles("shelves/rSFOF_ControlCentral_Run2016B_2fb_MC.pkl")
	#~ mcEndcapPkls = loadPickles("shelves/rSFOF_ControlForward_Run2016B_2fb_MC.pkl")
	dataPkls = loadPickles("shelves/rSFOF_Control_Run2016B_2fb_old.pkl")
	dataBarrelPkls = loadPickles("shelves/rSFOF_ControlCentral_Run2016B_2fb_old.pkl")
	dataEndcapPkls = loadPickles("shelves/rSFOF_ControlForward_Run2016B_2fb_old.pkl")
	mcPkls = loadPickles("shelves/rSFOF_Control_Run2016B_2fb_MC_old.pkl")
	mcBarrelPkls = loadPickles("shelves/rSFOF_ControlCentral_Run2016B_2fb_MC_old.pkl")
	mcEndcapPkls = loadPickles("shelves/rSFOF_ControlForward_Run2016B_2fb_MC_old.pkl")
