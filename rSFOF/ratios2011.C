...
int ratios2011(void) {
  ...
  // measured in nJets >= 2, MET < 50 
  getRmueAndError(17771*lumifactor,15553*lumifactor,rmue_c.v,rmue_c.e);
  getRmueAndError(10813*lumifactor,8598*lumifactor,rmue_f.v,rmue_f.e);
  ...
  // Trigger efficiencies, taken from 2011 publication
...
//  Rsfof_f.s  = sqrt(rsfof_rmue_f.s*rsfof_rmue_f.s+RT_f.s*RT_f.s);
  ...
  int nEM = 109*lumifactor, nEE = 57*lumifactor, nMM = 57*lumifactor;
  ...
  nEM = 24*lumifactor, nEE = 11*lumifactor, nMM = 18*lumifactor;
