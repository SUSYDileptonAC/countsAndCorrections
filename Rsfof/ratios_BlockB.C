...
int ratios_BlockB(void) {
  ...
  getRmueAndError(49008*lumifactor,41700*lumifactor,rmue_c.v,rmue_c.e);
  getRmueAndError(31342*lumifactor,22366*lumifactor,rmue_f.v,rmue_f.e);
...
//  getRmueAndError(28765,20429,rmue_f.v,rmue_f.e);
  ...
  int kEE_c = 1329*lumifactor, nEE_c = 1373*lumifactor, kMM_c = 235*lumifactor, nMM_c = 245*lumifactor, kEM_c = 111*lumifactor, nEM_c = 116*lumifactor;
  int kEE_f =  382*lumifactor, nEE_f =  393*lumifactor, kMM_f =  96*lumifactor, nMM_f =  100*lumifactor, kEM_f = 19*lumifactor, nEM_f = 25*lumifactor;
...
//  Rsfof_f.s  = sqrt(rsfof_rmue_f.s*rsfof_rmue_f.s+RT_f.s*RT_f.s);
  ...
  int nEM = 390*lumifactor, nEE = 184*lumifactor, nMM = 210*lumifactor;
  ...
  nEM = 97*lumifactor, nEE = 40*lumifactor, nMM = 52*lumifactor;
