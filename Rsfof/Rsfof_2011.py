...
if (__name__ == "__main__"):
	...
	cuts = "weight*(chargeProduct < 0 && %s && p4.M() > 20 && p4.M() < 70 && met > 100 && met < 150 && (nJets ==2 && jet1pt > 40) && %s && deltaR > 0.3 && runNr <= 201678 && !(runNr >= 198049 && runNr <= 198522) )"%(ptCut,etaCut)
	...
	if data:
		outFilePkl = open("shelves/rSFOF_Data2011_%s.pkl"%suffix,"w")
	else:
