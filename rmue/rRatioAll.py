...
class Ratio_id1_MC(): #id1
	variable = "id1"
	filename = "r-Abh_id1"
	cut=Cuts.basicOhneNJetPlusInvMass+" && id2 < 0.05"
...
class Ratio_id2_MC(): #id2
	variable = "id2"
	filename = "r-Abh_id2"
	cut=Cuts.basicOhneNJetPlusInvMass+" && id1 < 0.05"
	binning=[-0.01+i*0.01 for i in range(0,17)]
	processes=[Processes7TeV.TTJets, Processes7TeV.ZJets,Processes7TeV.SingleT,Processes7TeV.DiBoson]
	processes8TeV=[Processes8TeV.TTJets]
	xaxis=Titles.id2
...
#	SubProcesses8TeV.dataPath = "../Daten/"
	...
	if variante==1: 
		filename="8TeVrRatioDataVsMC_slope_%s" %plotMC.variable
		...
		if plotMC==Ratio_id2_002_MC:
			filename="8TeVrRatioDataVsMC_id2_002"
		elif plotMC==Ratio_id1_002_MC:
			filename="8TeVrRatioDataVsMC_id1_002"
		elif plotMC==Ratio_p4M_MC:
			filename="8TeVrRatioDataVsMC_mll"
		elif plotMC==Ratio_p4M_MCtt:
			filename="8TeVrRatioDataVsMC_mll_tt"
		elif plotMC==Ratio_p4M_MCZ:
			filename="8TeVrRatioDataVsMC_mll_Z"
	
	# variante 2 = ohne slope
	elif variante==2:
		filename="8TeVrRatioDataVsMC_%s" %variable
		linearMC = ROOT.TF1("linear", "[0]", xMin , xMax)
		linearMC.SetLineColor(Colors.mc)
		linearData = ROOT.TF1("linear", "[0]", xMin , xMax)
		linearData.SetLineColor(Colors.data)
		if plotMC==Ratio_id2_002_MC:
			filename="8TeVrRatioDataVsMC_2_id2_002"
		elif plotMC==Ratio_id1_002_MC:
			filename="8TeVrRatioDataVsMC_2_id1_002"
		elif plotMC==Ratio_p4M_MC:
			filename="8TeVrRatioDataVsMC_mll"
		elif plotMC==Ratio_met_MC_tt:
			filename = "8TeVrRatioDataVsMC_met-tt"
		elif plotMC==Ratio_p4M_MCtt:
			filename="8TeVrRatioDataVsMC_mll_tt"
		elif plotMC==Ratio_p4M_MCZ:
			filename="8TeVrRatioDataVsMC_mll_Z"
		elif plotMC==Ratio_DeltaR_MCZ:
			filename="8TeVrRatioDataVsMC_DeltaR_Z"
		elif plotMC==Ratio_p4M_MCSS:
			filename="8TeVrRatioDataVsMC_mll_SS"
		elif plotMC==Ratio_p4M_MCIsoSideband:
			filename="8TeVrRatioDataVsMC_mll_IsoSideBand"
		elif plotMC==Ratio_p4M_MCControlSS:
			filename="8TeVrRatioDataVsMC_mll_SSControl"
	else:
